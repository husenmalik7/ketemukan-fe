...
function DeleteItemModal({
  ...
  return (
    <div
      id="popup-modal"
      tabIndex="-1"
      className={`${isDeleteModalOpen ? '' : 'hidden'} fixed top-0 right-0 left-0 z-50 flex h-screen max-h-full w-full items-center justify-center overflow-x-hidden overflow-y-auto bg-gray-100/70 md:inset-0`}
    >
      <div className="relative max-h-full w-full max-w-md p-4">
        <div className="relative rounded-lg bg-white shadow-sm">
          ...
          <div className="p-4 text-center md:p-5">
            <ImCross className="mx-auto mb-4 h-12 w-12 text-gray-400" />

            <h3 className="mb-5 text-lg font-normal text-gray-500">
              Apakah anda ingin menghapus item <br />
              <span className="font-bold">{deleteItemTitle}</span>
            </h3>
